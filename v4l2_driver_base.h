...
typedef struct __cam_base_data {
	...
	struct camera_sensor {
		...
		struct v4l2_frmsizeenum frms[MACRO_MAX_DISCREATE_FROMAT_SUPPORT];
		struct v4l2_frmsizeenum *fmt_frm_user;

		unsigned int total_frm_interval_support;
		struct v4l2_frmivalenum frm_interval_support[MACRO_MAX_DISCREATE_FROMAT_SUPPORT];
		struct v4l2_frmivalenum *frame_interval_frm_user;
